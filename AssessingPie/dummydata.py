...
def fill():
      try: 
           ...
           # class1=Query.addClass("Class1",  school.key, "A,B", "2012-2013")
            ...
            Query.assign_topics_to_subject(subject1.key, [topic.key,topic1.key],school.key)
            ...
            Query.get_topics_by_subject(subject1.key)
            Query.get_students_by_class(class1.key)
            Query.get_questions_by_topic_name("Number  System")
            a=Query.get_states_by_topic_name("Number  System")
